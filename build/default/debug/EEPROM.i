...
KEYPAD:
    ...
    MOVLW 0x44
    BTFSC PORTB, 0 ;REFERENCE KEYPAD DATASHEET. LETTER D IS IN COLUMN 1, AND ((PORTB) and 07Fh), 0 REPRESENTS COLUMN 1, ((PORTB) and 07Fh), 0 IS 0 WITHIN PORTB
    GOTO Display
